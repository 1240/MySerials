...
/**
 * An activity representing a single Serial detail screen. This
 * activity is only used narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link SerialListActivity}.
 */
public class SerialDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(SerialDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(SerialDetailFragment.ARG_ITEM_ID));
